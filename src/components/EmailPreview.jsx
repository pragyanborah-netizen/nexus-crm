...
<div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;color:#1e293b;">
  ...
  const inventoryHtml = (form.items_to_move || []).length > 0
    ...
    : `<p style="color:#64748b;font-style:italic;font-family:Arial,sans-serif;">No items listed.</p>`;
...
<div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;color:#1e293b;">
  ...
  <div style="padding:28px 32px;border:1px solid #e2e8f0;border-top:none;background:#fff;">
    ...
    <table style="width:100%;border-collapse:collapse;margin:12px 0 20px;">
      ...
      ${form.deposit ? `<tr><td style="padding:7px 10px;border:1px solid #e2e8f0;font-size:13.5px;font-family:Arial,sans-serif;">Deposit</td><td style="padding:7px 10px;border:1px solid #e2e8f0;font-size:13.5px;font-family:Arial,sans-serif;color:#1d4ed8;">$${Number(form.deposit).toLocaleString()} received</td></tr>` : ""}
    </table>
    ...
    <div style="background:#f0f7ff;border-left:4px solid #1d4ed8;border-radius:6px;padding:16px 20px;margin-bottom:20px;">
      ...
      <table style="width:100%;border-collapse:collapse;">
        ${serviceLines.map((s, i) => `<tr style="${i % 2 === 0 ? "background:#e8f4ff;" : ""}"><td style="padding:6px 8px;font-size:13.5px;font-family:Arial,sans-serif;">${s.label}${s.date ? " · " + s.date : ""}${s.time ? " at " + s.time : ""}</td><td style="padding:6px 8px;font-size:13.5px;font-family:Arial,sans-serif;text-align:right;">${s.hours ? s.hours + " hrs" : ""}</td><td style="padding:6px 8px;font-size:13.5px;font-family:Arial,sans-serif;text-align:right;">${s.total ? "$" + Number(s.total).toLocaleString() : ""}</td></tr>`).join("")}
        ${(flatRates || []).filter(r => r.description && r.amount).map((r, i) => `<tr style="${(serviceLines.length + i) % 2 === 0 ? "background:#e8f4ff;" : ""}"><td style="padding:6px 8px;font-size:13.5px;font-family:Arial,sans-serif;">${r.description}</td><td></td><td style="padding:6px 8px;font-size:13.5px;font-family:Arial,sans-serif;text-align:right;">$${Number(r.amount).toLocaleString()}</td></tr>`).join("")}
      </table>
    ...
    ${p("Wishing you all the best for your move.")}
