...
const policySections = [
  {
    ...
    highlight: "Payment begins at customer sign-on, not depot departure",
  },
  {
    title: "Travel Time to Job (≤30 min)",
    icon: MapPin,
    color: "bg-purple-600",
    content: "Travel time to the customer's location is not paid if the travel time from the depot or designated meeting point is 30 minutes or less.",
    highlight: "No payment for travel under 30 minutes",
  },
  {
    title: "Travel Time to Job (>30 min)",
    icon: AlertTriangle,
    color: "bg-orange-600",
    content: "If travel time exceeds 30 minutes, payment for any additional travel time will be at management's discretion or as otherwise agreed.",
    highlight: "Extended travel requires management approval",
  },
  {
